...
import { checkDomain, checkAlternativeTlds, getSuggestedTlds, POPULAR_TLDS, TECH_TLDS, COUNTRY_TLDS, } from "./domain-checker.js";
// Define MCP tools
const tools = [
    {
        name: "check_domain",
        description: "Check if a single domain name is available for registration. Uses both DNS and WHOIS lookups for reliability.",
        inputSchema: {
            type: "object",
            properties: {
                domain: {
    ...
    },
    {
        ...
        description: "Check domain availability across multiple TLDs. Useful for finding available alternatives when the primary TLD is taken.",
        inputSchema: {
            type: "object",
            properties: {
                name: {
                ...
                tlds: {
                    type: "array",
                    items: { type: "string" },
                    description: "List of TLDs to check. If not provided, checks popular TLDs.",
                },
                category: {
                    type: "string",
                    enum: ["general", "tech", "country", "all"],
                    description: "Category of TLDs to check if 'tlds' not provided. Default: general",
                },
            },
            required: ["name"],
        },
    },
    {
        ...
        description: "Suggest available domain names based on a keyword or phrase. Checks multiple variations and TLDs.",
        inputSchema: {
            type: "object",
            properties: {
                keyword: {
                ...
                includeVariations: {
                    type: "boolean",
                    description: "Include variations like adding 'app', 'hq', 'get' prefixes/suffixes. Default: true",
                },
            },
            required: ["keyword"],
        },
        ...
        switch (name) {
            ...
            case "check_alternative_tlds": {
                ...
                if (args?.tlds && Array.isArray(args.tlds)) {
                    ...
                    tlds = getSuggestedTlds(category);
                }
            ...
            case "suggest_domains": {
                ...
                const tlds = getSuggestedTlds(category);
